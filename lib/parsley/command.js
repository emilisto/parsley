...
_.extend(Command.prototype, {
  ...
  run: function() {
    ...
    _.invoke(this.callbacks, _.partial(this._dispatchCallback, args));
    _.invoke(this.error_callbacks, _.partial(this._dispatchCallback, args));
  ...
  saveCallbacks: function() {
    ...
    _.invoke(this.callbacks || [], 'save');
    _.invoke(this.error_callbacks || [], 'save');
  },
  save: function(callback) {
    ...
    this.log('debug', 'set key %s', key('command', this.id));
  },
